...
public class StoreTab : MonoBehaviour
{
    ...
    public void Select()
    {
        ...
        if (data.Type == ItemType.Plane)
        {
            GameBootstrap.PlaneToLoad = data.ItemGameID;
        }
        else
        {
            BackgroundManager.BGToLoad = data.ItemGameID;
        }
    ...
    public void SetData()
    {
        StoreItemData data = Items[currentSelectedID];
        if (data.Type == ItemType.Plane)
        {
            GameBootstrap.PlaneToLoad = data.ItemGameID;
        }
